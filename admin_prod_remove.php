    ...
    <div class="card-container">
        ...
        <div class="card-row">
            ...
            <div class="card-cell col-actions">
                ...
                <form method="POST" onsubmit="return confirm('Are you sure you want to permanently delete this product from the database?');">
                    <input type="hidden" name="product_id" value="<?= $product['product_id']?>">
...
<style>
    ...
    .col-image { flex: 0 0 120px; }
    .col-id { flex: 0 0 80px; }
    .col-name { flex: 2; }
    .col-category { flex: 1; }
    .col-quantity, .col-price, .col-status { flex: 0 0 80px; }
    .col-actions {
      flex: 1;
      display: flex;
