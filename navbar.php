...
<body>
    ...
    <footer class="bg-dark text-center text-lg-start fixed-bottom">
        <div class="container position-relative">
            ...
            <div class="footer-logo-container">
                <img src="logo-transparent.png" alt="Footer Logo" class="footer-logo" id="logo">
                <p>© Mind and Motion</p>
            </div>
        </div>
    </footer>
    ...
    <script src="https://code.jquery.com/jquery-3.5.1.slim.min.js" integrity="sha384-Df2hZ2htPH0lsSSs5nCTpuj/zyCU6mrxA6f4EJ5cltvjxjp6nE1MXA9G16p9b3F5" crossorigin="anonymous"></script>
    ...
    <!-- Custom Styles -->
    <style>
        /* Customizing navbar color and font */
        .bg-navy {
            background-color: #2a4d69 !important; /* New color */
        }

        body, .navbar, .dropdown-menu, footer {
            font-family: 'Merriweather', serif; /* Apply Merriweather font */
        }

        /* Ensure text is white for visibility */
        .navbar .navbar-nav .nav-link, .navbar .navbar-brand, footer a {
            color: white !important; /* Force text to be white */
        }

        .navbar .navbar-nav .nav-link:hover, footer a:hover {
