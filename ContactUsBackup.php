...
<html lang = "en">
    <head>
        ...
        <link rel = "stylesheet" href = "../css/stylesheet.css" type = "text/css"> <!-- Links to stylesheet -->
                    ...
                    <div class="card bg-light">
                      ...
                      <div class="card-body p-5">
                        <!-- Sets text to bold / uppercase -->
                          ...
                          <div class="mb-3">
                            <!-- Phone number for contacting user -->
                          ...
                          <!-- Date to choose about project inquiry -->
                          <div class = "mb-3">
